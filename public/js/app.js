    ...
    addItem: function addItem() {
      ...
      if (this.edit === false) {
        ...
        fetch('api/item', {
          ...
          _this3.item.title = '', _this3.item.quality = '', _this3.item.sell_in = '';
          alert('Item Added');
    ...
    [
        ...
        [
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.item.quality,
                  expression: "item.quality"
                }
              ],
              staticClass: "form-control",
              attrs: {
              ...
              domProps: { value: _vm.item.quality },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.item, "quality", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.item.sell_in,
                  expression: "item.sell_in"
                }
              ],
              staticClass: "form-control",
              attrs: {
              ...
              domProps: { value: _vm.item.sell_in },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.item, "sell_in", $event.target.value)
                }
              }
            })
          ]),
      ...
      _vm._l(_vm.items, function(item) {
        return _c("div", { key: item.id, staticClass: "card card-body mb-2" }, [
          ...
          _vm._v(" "),
          _c("p", [_vm._v("Quality: " + _vm._s(item.quality))]),
          _vm._v(" "),
          _c("p", [_vm._v("Sell In: " + _vm._s(item.sell_in))]),
          _vm._v(" "),
          _c("p", [
            _c(
              "button",
              {
                staticClass: "btn mb-2 btn-warning",
            ...
            _c(
              "button",
              {
                staticClass: "btn mb-2 btn-danger",
                attrs: { type: "button", name: "button" },
                on: {
                  click: function($event) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Items_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Items.vue */ "./resources/js/components/Items.vue");
...
__webpack_require__(/*! D:\workspace\public_html\Gilded-Rose-Items-REST-Service\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\workspace\public_html\Gilded-Rose-Items-REST-Service\resources\sass\app.scss */"./resources/sass/app.scss");
